...
* How much of economic value created by generative AI will come from improvements R+D versus general deployment? [HN thread](https://news.ycombinator.com/item?id=43447616), related to this [article](https://epoch.ai/gradient-updates/most-ai-value-will-come-from-broad-automation-not-from-r-d). Also referred to [2015 reaction wheel](https://reactionwheel.net/2015/10/the-deployment-age.html) about technology diffusion/deployment referencing Carlota Perez's theories. From this [HN comment](https://news.ycombinator.com/item?id=43448273)
